              ...
              <div className="hidden sm:ml-6 sm:block">
                <div className="flex items-center">
                  ...
                  {session ? (
                    ...
                    alt=""
                  /> */}
                          <UserCircleIcon className="h-10 w-10 rounded-full bg-primary text-gray-300" />
                        </Menu.Button>
                      </div>
                      <Transition
                        as={Fragment}
                    ...
                    <Link href="/login">
                      <button className="w-auto px-4 border-stone-400 bg-primary text-white hover:bg-stone-300 hover:text-slate-700  h-10 rounded-md border text-sm transition-all focus:outline-none">
                        Log In / Register
                      </button>
                    </Link>
                  )}
