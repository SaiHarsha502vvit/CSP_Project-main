...
export default function DataTable({
  ...
  return (
    <div className="mx-auto max-w-7xl ">
                          ...
                          <td className="hidden px-3 py-4 text-sm md:table-cell">
                            {dish.ingredients.map((i) => (
                              <span
                                ...
                                className=" inline-flex items-center rounded-full bg-slate-600 ring-1 ring-slate-500 ring-inset px-2 py-1 m-1 text-xs font-normal text-center text-white"
                              >
                                {i.name}
                              </span>
                            ))}
      ...
      <button
        className="float-right px-2 mr-2 md:mr-6 mb-8 md:mb-0 border-stone-400 bg-primary text-sm text-white hover:bg-white hover:text-slate-700 h-10 rounded-md border transition-all focus:outline-none"
