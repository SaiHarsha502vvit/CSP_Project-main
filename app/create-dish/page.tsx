      ...
      <div className="w-screen flex flex-col justify-center items-center">
        ...
        <div className="text-center max-w-screen-lg mb-10">
          ...
          <button
            ...
            className=" mt-8 w-72 border-stone-400 bg-primary text-white hover:bg-white hover:text-slate-700  h-10  items-center justify-center rounded-md border text-sm transition-all focus:outline-none"
          >
