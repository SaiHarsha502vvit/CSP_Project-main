...
export default function Home() {
  return (
    <>
      <Head>
        <title>Simple Nutrition | Home</title>
        <meta name="description" content="Keep track of your daily nutrition intake." />
        <meta property="og:title" content="Simple Nutrition" />
        <meta property="og:description" content="Keep track of your daily nutrition intake." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://simple-nutrition.vercel.app/" />
        <meta property="og:image" content="/logo.png" />
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "WebSite",
          "name": "Simple Nutrition",
          "url": "https://simple-nutrition.vercel.app/"
        }) }} />
      </Head>
      <div className="flex h-full bg-primary">
        <div className="w-screen h-screen flex flex-col justify-center items-center">
          ...
          {/* <div className="flex space-x-3">
            <Link href="/login">
              <button className="w-36 border-stone-400 bg-primary text-white hover:bg-white hover:text-slate-700  h-10  items-center justify-center rounded-md border text-sm transition-all focus:outline-none">
                Sign In
              </button>
            </Link>
            <Link href="/register">
          ...
          <div>
            <Link href="/multi-search">
              <button className="w-[300px] mt-2 border-stone-400 bg-primary text-white hover:bg-white hover:text-slate-700  h-10  items-center justify-center rounded-md border text-sm transition-all focus:outline-none">
                Search Ingredients
              </button>
            </Link>
          </div>
